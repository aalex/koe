...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 285.5, 145.0, 32.5, 20.0 ],
					"text" : "f"
				}
...
, 			{
				"box" : 				{
					"comment" : "image blurred",
					"id" : "obj-3",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.244202, 338.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 285.5, 107.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 188.244202, 133.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 337.0, 204.0, 97.0, 24.0 ],
					"text" : "blur amount"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.0, 271.0, 65.0, 18.0 ],
					"text" : "width 0 $1"
				}
...
,
					"patching_rect" : [ 188.244202, 293.0, 67.0, 20.0 ],
					"text" : "jit.gl.pix #1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 273.0, 204.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.0, 206.0, 65.0, 18.0 ],
					"text" : "width $1 0"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 424.0, 79.0, 297.0, 289.0 ],
									"text" : "texcoordM = texcoord;\ntexcoordB0 = texcoord - width;\ntexcoordF0 = texcoord + width;\ntexcoordB1 = texcoord - width * 2.0;\ntexcoordF1 = texcoord + width * 2.0;\ntexcoordB2 = texcoord - width * 3.0;\ntexcoordF2 = texcoord + width * 3.0;\n\n\nvec4 sampleM  = texture2DRect(image, texcoordM);\nvec4 sampleB0 = texture2DRect(image, texcoordB0);\nvec4 sampleF0 = texture2DRect(image, texcoordF0);\nvec4 sampleB1 = texture2DRect(image, texcoordB1);\nvec4 sampleF1 = texture2DRect(image, texcoordF1);\nvec4 sampleB2 = texture2DRect(image, texcoordB2);\nvec4 sampleF2 = texture2DRect(image, texcoordF2);\n\ngl_FragColor = 0.1752 * sampleM + \n0.1658 * (sampleB0 + sampleF0) + \n0.1403 * (sampleB1 + sampleF1) + \n0.1063 * (sampleB2 + sampleF2);"
								}
...
,
					"patching_rect" : [ 188.244202, 229.0, 67.0, 20.0 ],
					"text" : "jit.gl.pix #1"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 282.5, 261.0, 210.5, 261.0 ],
					"source" : [ "obj-68", 0 ]
				}
